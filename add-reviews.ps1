...
# Add 4 new testimonials after the 3rd card (before the closing grid div)
...
$newTestimonials = '                            <div class="text-gray-400 text-xs">Kakoba Community</div>
                        </div>
                    </div>
                </div>
...
Set-Content $f $c
Write-Host "Added 4 more testimonials!" -ForegroundColor Green
